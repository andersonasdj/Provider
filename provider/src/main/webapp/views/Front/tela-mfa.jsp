...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="logarMfa" id="logarMfa">
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fa fa-asterisk"></i></span>
						</div>
						<input type="text" class="form-control" name="mfa" placeholder="usuario" required autofocus>
					</div>
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center">
					<a href="mailto:suporte@providerone.com.br">Não recebeu o código?</a>
				</div>
			</div>
		</div>
	</div>
